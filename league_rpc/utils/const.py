...
QUEUE_ID_CUSTOM_GAME_ARAM = 3120
QUEUE_ID_CUSTOM_GAME_TOURNAMENT = 3130
QUEUE_ID_PRACTICE_TOOL = 3140
QUEUE_ID_ARAM_CUSTOM_BLIND = 3200
QUEUE_ID_ARAM_CUSTOM_DRAFT = 3210
QUEUE_ID_ARAM_CUSTOM_ALL_RANDOM = 3220
QUEUE_ID_ARAM_CUSTOM_TOURNAMENT = 3230
QUEUE_ID_ARAM_CUSTOM_MAYHEM = 3270

CUSTOM_GAME_QUEUE_IDS = (
    QUEUE_ID_CUSTOM_GAME,
    QUEUE_ID_CUSTOM_GAME_DRAFT,
    QUEUE_ID_CUSTOM_GAME_ARAM,
    QUEUE_ID_CUSTOM_GAME_TOURNAMENT,
    QUEUE_ID_ARAM_CUSTOM_BLIND,
    QUEUE_ID_ARAM_CUSTOM_DRAFT,
    QUEUE_ID_ARAM_CUSTOM_ALL_RANDOM,
    QUEUE_ID_ARAM_CUSTOM_TOURNAMENT,
    QUEUE_ID_ARAM_CUSTOM_MAYHEM,
)
